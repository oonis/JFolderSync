...
/**
 * Interface definition of the directory watch service.
 *
 ...
 */
public interface IDirectoryWatchService extends Service {
     ...
     *
     * @param listener <code>OnFileChangeListener</code> The listener.
     * @param dirPath <code>String</code > The directory path.
